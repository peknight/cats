...
object MonadApp extends App:
  ...
  println(retry(100)(a => if a == 0 then Option.empty[Int] else Option(a - 1)))
  println(retryTailRecM(100000)(a => if a == 0 then Option.empty[Int] else Option(a - 1)))
  println(retryM(100000)(a => if a == 0 then Option.empty[Int] else Option(a - 1)))
